...
<div class="container-login100">
    <div class="wrap-login100 p-6">
        <div class="d-flex justify-content-center align-items-center">
            <img src="{{url('/assets/default/web/default.png')}}" height="120px" class="" alt="logo">
        </div>
        ...
        <br>
        <center><p>Dibuat oleh <a href='https://alfatindo.net.id/' title='Alfatihindo' target='_blank'>Alfatihindo</a></p></center>
