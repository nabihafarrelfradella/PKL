...
class LapStokBarangController extends Controller
{
    ...
    {
        $query = BarangModel::leftJoin('tbl_jenisbarang', 'tbl_jenisbarang.jenisbarang_id', '=', 'tbl_barang.jenisbarang_id')->leftJoin('tbl_merk', 'tbl_merk.merk_id', '=', 'tbl_barang.merk_id')->orderBy('barang_id', 'DESC');
        
        if ($request->tipe) {
            $query->where('tbl_jenisbarang.jenisbarang_ket', $request->tipe);
        }
    ...
    public function show(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->rawColumns(['stokawal', 'jmlmasuk', 'jmlkeluar', 'totalstok', 'tipe'])->make(true);
        }
    }
}
