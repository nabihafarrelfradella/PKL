...
class JenisBarangController extends Controller
{
    ...
    {
        $data["title"] = "Jenis";
        $data["hakTambah"] = $this->checkAccess(Session::get('user')->role_id, '/jenisbarang', 'create');
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $hakEdit = $this->checkAccess($roleId, '/jenisbarang', 'update');
                    $hakDelete = $this->checkAccess($roleId, '/jenisbarang', 'delete');
